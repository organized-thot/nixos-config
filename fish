...
_shtab_aider_options=(
  ...
  "--input-history-file[Specify the chat input history file (default\: \/etc\/nixos\/.aider.input.history)]:input_history_file:_files"
  "--chat-history-file[Specify the chat history file (default\: \/etc\/nixos\/.aider.chat.history.md)]:chat_history_file:_files"
