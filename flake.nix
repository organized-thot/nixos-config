{
  ...
  outputs = inputs@{ self, nixpkgs, garuda, home-manager, nix-snapd, ... }: {
    nixosConfigurations.nixos-garuda = garuda.lib.garudaSystem { # NixOS configurations
      system = "x86_64-linux";
...
#            home-manager.users.nix-user = ./home.nix;
        ...
        nix-snapd.nixosModules.default { # Enable snapd module
